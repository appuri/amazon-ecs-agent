...
docker: certs build-in-docker
	...
	docker build -f scripts/dockerfiles/Dockerfile.release -t "quay.io/appuri/amazon-ecs-agent:1.14.0" .
	echo "Built Docker image \"quay.io/appuri/amazon-ecs-agent:1.14.0\""
